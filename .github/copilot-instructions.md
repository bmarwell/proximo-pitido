...
- `war/src/main/java/.../SipRegistrationServlet.java` — `loadOnStartup=1`, `doResponse()` for REGISTER 401/200
- `war/src/main/java/.../SipCallServlet.java` — `doInvite()`, `doInfo()` (DTMF), `doBye()`
